...
import { TrendingUp, AlertCircle, Building, Users, Receipt, PieChart } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 stagger-5 animate-slide-up opacity-0">
            ...
            <div className="p-4 border-t border-slate-100 bg-slate-50/30">
                <button 
                    ...
                    className="w-full text-center text-sm font-bold text-indigo-600 hover:text-indigo-800 transition-colors py-2"
                >
